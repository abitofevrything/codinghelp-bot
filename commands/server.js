...
module.exports = {
    ...
    execute(message, args) {   
            ...
            .addFields (
                ...
                { name: '♾️ Invite your friends!', value: 'https://discord.gg/REjFpZ9' },
            )
            ...
            .setColor('GREEN')
            .setTitle('Our Rules')
            .setDescription('If you want to read about all of our rules in detail you can check out [our website](https://codinghelp.site/wiki/rules/discord-server-rules).')
            .addFields (
                { name: 'Rule 1', value: 'No spam, advertising or NSFW content. Be nice. Use common sense.\n\nIf you are found to post spam or advertise, you will be warned or banned as stated [here](https://codinghelp.site/wiki/rules/warnings-bannings/).' },
                { name: 'Rule 2', value: '[Don’t ask if you can ask a question, just ask it!](https://codinghelp.site/wiki/faq/just-ask/) If someone knows the answer, they’ll do their best to help.' },
                { name: 'Rule 3', value: 'If you need help with a problem in your code, always provide the raw code in GitHub gist or a similar place. If you aren’t sure what places, you can check [this article](https://codinghelp.site/wiki/faq/share-code/).' }, 
                { name: 'Rule 4', value: 'Do not message the mods directly for any reason. If you are wanting to message the mods, please use the Modmail bot <@754368625216978965>. If you are messaging the mods directly, your messages will be ignored. If you are continually messaging the mods, you will be [warned or banned](https://codinghelp.site/wiki/rules/warnings-bannings/).' }, 
            ...
            .setDescription('Great question! We have that explained on [our wiki](https://codinghelp.site/wiki/faq/share-code/).');
            ...
            if(message.member.roles.cache.has('718253309101867008')) {
