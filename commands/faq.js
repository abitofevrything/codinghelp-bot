...
module.exports = {
    ...
    execute(message, args) {
		...
		if(!user) {
			...
			message.channel.send(`Hey, ${usr}!` +  ' Please check out the <#742604331215487006> channel or the <#742594501922652260> channel as we have a lot of questions answered in those two places. If it isn\'t answered there then you may leave your question here for others to help you answer. Thank you!\nYou can also check our website to see if your quesiton is answered: https://codinghelp.site');
		}
