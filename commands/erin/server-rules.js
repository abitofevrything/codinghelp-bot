...
module.exports = {
    ...
    execute(message) {
        ...
        const rulesEmbed2 = new Discord.MessageEmbed()
            ...
            .addFields(
                { name: 'Rule 1', value: 'No spam, advertising or NSFW content. Be nice. Use common sense.\n\nIf you are found to post spam or advertise, you will be warned or banned as stated [here](https://codinghelp.site/all-rules/).' },
                { name: 'Rule 2', value: '[Don’t ask if you can ask a question, just ask it!](https://codinghelp.site/all-rules/) If someone knows the answer, they’ll do their best to help.' },
                { name: 'Rule 3', value: 'If you need help with a problem in your code, always provide the raw code in GitHub gist or a similar place. If you aren’t sure what places, you can check [this article](https://codinghelp.site/) or send yourself a DM from the bot by using \`/format @your-username\` replacing \`@your-username\` with a ping to yourself.' },
                { name: 'Rule 4', value: 'Do not message the mods directly for any reason. If you are wanting to message the mods, please message <@575252669443211264> to contact the mods. If you are messaging the mods directly, your messages will be ignored. If you are continually messaging the mods, you will be [warned or banned](https://codinghelp.site/all-rules/).' },
            ...
            components: [
              {
                ...
                url: `https://codinghelp.site/all-rules/`
              }
            ]
          }
        ] });
