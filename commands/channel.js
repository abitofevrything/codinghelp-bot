...
module.exports = {
    ...
    execute(message, args) {   
            ...
            .addFields (
                ...
                { name: 'r/CodingHelp Bot', value: '<#757041789688479805> - This is where you can talk about anything that doesn\'t have to do with programming.\n<#757041736047656980> - This is where you can run commands for the bot.' }, 
                { name: 'Off Topic', value: '<#359760149683896322> - This is where you can talk about anything that doesn\'t have to do with programming.\n<#382912135619149835> - This is where you can post memes. Note: You do have to be 18 or older to access this channel.\n<#433962402292432896> - This is where you can run commands for any bot besides r/CodingHelp Bot.' }, 
                { name: 'Voice Channels', value: 'This is where you can join to talk to fellow members of our server.' }, 
            )
            .setFooter('Last Updated by cute.as.ducks#8061')
            .setTimestamp();
